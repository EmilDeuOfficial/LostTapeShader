...
void main() {
    ...
    // Selbst-Benebelung an der eigenen Distanz — fernes Wasser traegt so
    // seinen vollen Nebel und stoesst hinter Glas nicht mehr hart an den
    // vollnebligen Himmel (Ozean-Horizont-Kante)
