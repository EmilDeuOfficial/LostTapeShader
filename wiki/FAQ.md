...
Iris stores tweaks in a `.txt` named after the zip (`Lost_Tape_v1.5.zip.txt`). When the file name changes with a new version, settings start fresh. Back up the `.txt`, or rebuild your look from the closest preset.
